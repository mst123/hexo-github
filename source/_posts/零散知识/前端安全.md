...
前端和服务端设置 [CSP](https://developer.mozilla.org/zh-CN/docs/Web/HTTP/CSP) 的效果相同，但是`meta`无法使用`report`
...
[阮一峰samesite](https://www.ruanyifeng.com/blog/2019/09/cookie-samesite.html)
