...
2. 普通元素设置`position`属性为**非**`static`值并设置`z-index`属性为**具体数值**，产生层叠上下文(不同浏览器表现可能不一致)。
3. CSS3中的新属性也可以产生层叠上下文。
   1. `z-index`值不为`auto`的`flex`**子项**(父元素`display:flex|inline-flex`).
   2. 元素的`opacity`值不是`1`.
...
![更完整的7阶层叠顺序图](层叠上下文.assets/2016-01-09_211116.png)
...
![网页中z轴示意](层叠上下文.assets/z-aris.png)
...
![层叠顺序](层叠上下文.assets/2016-01-07_223349.png)
...
![疑问](层叠上下文.assets/ask.gif)

为什么呢？我明明感觉浮动元素和块状元素要更屌一点啊。

嘿嘿嘿，我就不卖关子了，直接看下图的标注说明：
![层叠顺序元素的标注说明](层叠上下文.assets/2016-01-07_235108.png)
...
![浮动和文字重叠](层叠上下文.assets/2016-01-07_235830.jpg)
...
![img](层叠上下文.assets/mm1.jpg)

![img](层叠上下文.assets/mm2.jpg)
...
![百合大法好](层叠上下文.assets/2016-01-08_220622.jpg)

为什么小小的改变会有想法的结果呢？
![思考](层叠上下文.assets/think-2.gif)
...
![负值z-index的层叠顺序](层叠上下文.assets/2016-01-08_235511.png)
...
![img](层叠上下文.assets/2016-01-08_235217.png)
...
![img](层叠上下文.assets/mm1.jpg)![img](层叠上下文.assets/mm2.jpg)
...
![文字在妹子上](层叠上下文.assets/2018-01-09_004641.png)

但是，一旦图片开始走fadeIn淡出的CSS3动画，文字跑到图片后面去了![img](层叠上下文.assets/36.gif)：

![文字跑到图片后面](层叠上下文.assets/2018-01-09_004654.png)
